...
export function PublicDishGrid({ dishes, categories }: { dishes: PublicDish[]; categories: Category[] }) {
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {paginatedDishes.map((dish) => {
            ...
            <button
              ...
              className={`group relative text-left overflow-hidden rounded-xl border bg-card shadow-sm transition-all ${
                isOutOfStock
            ...
            <div className="grid gap-0 md:grid-cols-[1fr_1fr]">
              <div className="aspect-[4/3] md:aspect-auto overflow-hidden bg-muted md:rounded-l-2xl">
                {selectedDish.image ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center text-7xl text-muted-foreground/50">🍽</div>
                )}
              </div>
